...
{
    class OrbitalSpawn : SimpleUseable
    {
        public OrbitalSpawn(BaseCharacter owner, string name, float cooldown) : base(owner)
        {
            Name = name;
            Cooldown = cooldown;
        }
        ...
        protected override void Activate()
        {
            ...
            try
            {
                ...
                GameObject molotov = PhotonNetwork.Instantiate("Buildables/OrbitalStrike", spawnPos, Quaternion.LookRotation(direction));
